        ...
        <section>
            ...
            <article className=" mx-20 my-24 shadow-lg shadow-slate-400 flex items-center">
                <section className="w-1/2 flex flex-col items-center">
                    <img className="w-full object-cover" src="https://www.ford.com/cmslibs/content/dam/vdm_ford/live/en_us/ford/nameplate/mache/2022/collections/3_2/C11023722_mach-e-fordpass_mj.jpg/jcr:content/renditions/cq5dam.web.768.768.jpeg" alt="ford" />
            ...
            <article className="flex flex-col items-center w-full">
                ...
                <img className="shadow-md shadow-slate-500" src="https://www.ford.com/is/image/content/dam/vdm_ford/live/en_us/ford/nameplate/mache/2023/collections/dm/22_FRD_MCH_48126.tif?croppathe=1_21x9&wid=2160" alt="mustang" />
            </article>
